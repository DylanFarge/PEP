...
class Application():
    ...
    check = tk.Checkbutton(master=frameMain, text="Students can rate themselves", variable=check_var, bg="white", highlightthickness=0, activeforeground="#08F", activebackground="white", font=get_fonts("subheading"), state="disabled")
